...
rho_min=[0.24,0.24,0.23,0.23,0.23,0.23,0.23,0.23,0.23,0.23];
rho_max=[0.8,0.79,0.8,0.79,0.79,0.78,0.78,0.79,0.78,0.78];
...
hold on;
box on;
plot(log2(m),rho_max,'-o',"color",'r','linewidth',1.5)
plot(log2(m),b,'-x',"color",'k','linewidth',1.5)
plot(log2(m),rho_min,'-d',"color",'r','linewidth',1.5)

plot(log2(m),a,'-',"color",'k','linewidth',1.5)
ylim([0,1])
...
saveTightFigure(figure(1),"rho_vs_m.png")