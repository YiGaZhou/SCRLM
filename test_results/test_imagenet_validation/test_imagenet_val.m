...
T1=table(Acc_cl,Acc_sc,Acc_tsne,Acc_em,Acc_td,Acc_scrlm,Acc_kmeans,Acc_scrlm_kmeans,Acc_robust_kmeans,'VariableNames', {'CL','SC','tsne+kmeans++','EM','TD','SCRLM','kmeans++','scrlm+kmeans','robust kmeans++'});
writetable(T1, 'Acc_imagenet_val.txt')

T2=table(t_cl,t_sc,t_tsne,t_em,t_td,t_scrlm,t_kmeans,t_scrlm_kmeans,t_robust_kmeans,'VariableNames', {'CL','SC','tsne+kmeans++','EM','TD','SCRLM','kmeans++','scrlm+kmeans','robust kmeans++'});
writetable(T2, 'Time_imagenet_val.txt')

T3=table(a1,a2,a3,a4,a5,a6,a7,a8,a9,'VariableNames', {'CL','SC','tsne+kmeans++','EM','TD','SCRLM','kmeans++','scrlm+kmeans','robust kmeans++'});
writetable(T3, 'Acc_imagenet_val_avg.txt')

T4=table(t11,t22,t33,t44,t55,t66,t77,t88,t99,'VariableNames', {'CL','SC','tsne+kmeans++','EM','TD','SCRLM','kmeans++','scrlm+kmeans','robust kmeans++'});
writetable(T4, 'Time_imagenet_val_avg.txt')
